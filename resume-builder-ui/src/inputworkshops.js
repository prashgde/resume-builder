...
class InputWorkshops extends Component {
    constructor(props) {
        super(props)
        this.state = {
            inputList: [],
                ...
                <form>
                    ...
                    <div style={styles.fab}>
                        <Fab color="primary" size="medium" onClick={() => {
                            ...
                            <AddIcon />
                        </Fab> &nbsp;&nbsp; <label style={styles.strongLabel}>Click here to add another workshop</label>
                    </div>
...
export function Input(props) {
    return (
        <div className="main" style={styles.main}>
            <h3 style={styles.h3}>Workshop {props.inputNumber}</h3>
                ...
                <div style={styles.inputContainer}>
                    <div style={styles.textFieldContainer}>
                        <TextField
                            ...
                            fullWidth
                            label="Required"
                            helperText="Workshop you attended"
                        />
                    </div>
                </div>
            </div>
