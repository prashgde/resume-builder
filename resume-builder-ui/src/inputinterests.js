...
export function Input(props) {
    return (
        <div className="main" style={styles.main}>
            <h3 style={styles.h3}>Interest {props.inputNumber}</h3>
                ...
                <div style={styles.inputContainer}>
                    <div style={styles.textFieldContainer}>
                        <TextField
                            ...
                            variant="outlined"
                            label="Required"
                            helperText="Category (Eg. Music, Sports etc.)"
                        />
                    </div>
                    <div style={styles.textFieldContainer}>
                        <TextField
                            ...
                            fullWidth
                            label="Required"
                            helperText="Your interests that belongs to the category. Enter them comma seperated. They will be represented as bulleted lists."
                        />
                    </div>
                </div>
            </div>
